*----------------------------------------------------------------------------------*
*-----------------(RD- two steps  whole Commercial data	10/5/2020 -------------*
*----------------------------------------------------------------------------------*
...
*use "/Volumes/TOSHIBA/Lucy/IL/Analysis/Stata/test/commercial_1p.dta", clear



tempfile c30step1file
use "newdata/2020commercial.dta", clear 
drop if year==.
...
graph export "RD/commercial/offpeak_global3rd_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/offpeak_global4th_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/offpeak_global5th_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/offpeak_global6th_school.eps", replace as(eps)
...
title(Commercial, size(medlarge) color(black)) subtitle(Offpeak, size(medsmall) margin(bottom)) ///
xtitle(Date) ytitle(Residuals of hourly electricity usage (in log))
graph export "RD/commercial/offpeak_localonestages_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/offpeak_locallinear_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/offpeak_locallinear_school16_4.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/offpeak_locallinear_school4.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daypeak_global3rh_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daypeak_global4th_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daypeak_global5th_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daypeak_global6th_school.eps", replace as(eps)
...
(lpoly residuals day if day>=17, bw(2.5) kernel(gau) lwidth(thin) lcolor(gs6)), ///
xline( 17, lcolor(navy) lpattern(dash)) legend(off) xlabel(0(1)31,labsize(small)) ///
title(Commercial, size(medlarge) color(black)) subtitle(Day peak, size(medsmall) margin(bottom)) ///
xtitle(Date) ytitle(Residuals of hourly electricity usage (in log))
graph export "RD/commercial/daypeak_localonestages_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daypeak_locallinear_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daypeak_locallinear_school16_4.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daypeak_locallinear_school4.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/eveningpeak_global3rd_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/eveningpeak_global4th_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/eveningpeak_global5th_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/eveningpeak_global6th_school.eps", replace as(eps)
...
(lpoly residuals day if day>=17, bw(2.5) kernel(gau) lwidth(thin) lcolor(gs6)), ///
xline( 17, lcolor(navy) lpattern(dash)) legend(off) xlabel(0(1)31,labsize(small)) ///
title(Commercial, size(medlarge) color(black)) subtitle(Evening peak, size(medsmall) margin(bottom)) ///
xtitle(Date) ytitle(Residuals of hourly electricity usage (in log))
graph export "RD/commercial/eveningpeak_localonestages_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/eveningpeak_locallinear_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/eveningpeak_locallinear_school16_4.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/eveningpeak_locallinear_school4.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/superpeak_3rd.eps_school", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/superpeak_global4th_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/superpeak_global5th_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/superpeak_global6th_school.eps", replace as(eps)
...
(lpoly residuals day if day>=17, bw(2.5) kernel(gau) lwidth(thin) lcolor(gs6)), ///
xline( 17, lcolor(navy) lpattern(dash)) legend(off) xlabel(0(1)31,labsize(small)) ///
title(Commercial, size(medlarge) color(black)) subtitle(Super peak, size(medsmall) margin(bottom)) ///
xtitle(Date) ytitle(Residuals of hourly electricity usage (in log))
graph export "RD/commercial/superpeak_localonestages_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/superpeak_locallinear_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/superpeak_locallinear_school16_4.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/superpeak_locallinear_school4.eps", replace as(eps)
*----------------------------------------------------------------------------------*
*-----------Daily   08/4/2020------------------------------------------------------*
*----------------------------------------------------------------------------------*
clear
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daily_global3rd_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daily_global4th_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daily_global5th_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daily_global6th_school.eps", replace as(eps)
...
(lpoly residuals day if day>=17, bw(2.5) kernel(gau) lwidth(thin) lcolor(gs6)), ///
xline( 17, lcolor(navy) lpattern(dash)) legend(off) xlabel(0(1)31,labsize(small)) ///
title(Commercial, size(medlarge) color(black)) subtitle(Daily, size(medsmall) margin(bottom)) ///
xtitle(Date) ytitle(Residuals of hourly electricity usage (in log))
graph export "RD/commercial/daily_localonestages_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daily_locallinear_school.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daily_locallinear_school16_4.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daily_locallinear_school4.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/offpeak_global3rd_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/offpeak_global4th_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/offpeak_global5th_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/offpeak_global6th_order.eps", replace as(eps)
...
title(Commercial, size(medlarge) color(black)) subtitle(Offpeak, size(medsmall) margin(bottom)) ///
xtitle(Date) ytitle(Residuals of hourly electricity usage (in log))
graph export "RD/commercial/offpeak_localonestages_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/offpeak_locallinear_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/offpeak_locallinear5_9_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/offpeak_locallinear5_5_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daypeak_global3rd_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daypeak_global4th_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daypeak_global5th_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daypeak_global6th_order.eps", replace as(eps)
...
title(Commercial, size(medlarge) color(black)) subtitle(Day peak, size(medsmall) margin(bottom)) ///
xtitle(Date) ytitle(Residuals of hourly electricity usage (in log))
graph export "RD/commercial/daypeak_localonestages_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daypeak_locallinear_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daypeak_locallinear5_9_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daypeak_locallinear5_5_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/eveningpeak_global3rd_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/eveningpeak_global4th_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/eveningpeak_global5th_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/eveningpeak_global6th_order.eps", replace as(eps)
...
title(Commercial, size(medlarge) color(black)) subtitle(Evening peak, size(medsmall) margin(bottom)) ///
xtitle(Date) ytitle(Residuals of hourly electricity usage (in log))
graph export "RD/commercial/eveningpeak_localonestages_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/eveningpeak_locallinear_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/eveningpeak_locallinear5_9_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/eveningpeak_locallinear5_5_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/superpeak_global3rd_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/superpeak_global4th_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/superpeak_global5th_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/superpeak_global6th_order.eps", replace as(eps)
...
title(Commercial, size(medlarge) color(black)) subtitle(Super peak, size(medsmall) margin(bottom)) ///
xtitle(Date) ytitle(Residuals of hourly electricity usage (in log))
graph export "RD/commercial/superpeak_localonestages_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/superpeak_locallinear_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/superpeak_locallinear5_9_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/superpeak_locallinear5_5_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daily_global3rd_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daily_global4th_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daily_global5th_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daily_global6th_order.eps", replace as(eps)
...
title(Commercial, size(medlarge) color(black)) subtitle(Daily, size(medsmall) margin(bottom)) ///
xtitle(Date) ytitle(Residuals of hourly electricity usage (in log))
graph export "RD/commercial/daily_localonestages_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daily_locallinear_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daily_locallinear5_9_order.eps", replace as(eps)
...
(line line2 day, lcolor(black) lpattern(solid)), ///
ytitle("Residuals of hourly electricity usage (in log)") xtitle("Date") legend(off)
graph export "RD/commercial/daily_locallinear5_5_order.eps", replace as(eps)
...
title(Commercial, size(medlarge) color(black)) subtitle(Offpeak, size(medsmall) margin(bottom)) ///
xtitle(Date) ytitle(Residuals of hourly electricity usage (in log))
graph export "RD/commercial/offpeak_localtwostages.eps", replace as(eps)
...
title(Commercial, size(medlarge) color(black)) subtitle(Day peak, size(medsmall) margin(bottom)) ///
xtitle(Date) ytitle(Residuals of hourly electricity usage (in log))
graph export "RD/commercial/daypeak_localtwostages.eps", replace as(eps)
...
title(Commercial, size(medlarge) color(black)) subtitle(Evening peak, size(medsmall) margin(bottom)) ///
xtitle(Date) ytitle(Residuals of hourly electricity usage (in log))
graph export "RD/commercial/eveningpeak_localtwostages.eps", replace as(eps)
...
title(Commercial, size(medlarge) color(black)) subtitle(Super peak, size(medsmall) margin(bottom)) ///
xtitle(Date) ytitle(Residuals of hourly electricity usage (in log))
graph export "RD/commercial/superpeak_localtwostages.eps", replace as(eps)
...
title(Commercial, size(medlarge) color(black)) subtitle(Daily, size(medsmall) margin(bottom)) ///
xtitle(Date) ytitle(Residuals of hourly electricity usage (in log))
graph export "RD/commercial/daily_localtwostages.eps", replace as(eps)
